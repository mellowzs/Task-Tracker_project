        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center" style="font-weight: bold;">Task Details </h3><br>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <a title="Update Task"  href="task-info.php"><span class="btn btn-success-custom btn-xs" style="border-radius: 15px;">Go Back</span></a>
                              </div>
                            </div>
                          </form> 
                        </div>
