            ...
            <div class="col-md-12">
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-5">Due on</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_task_post" class="btn btn-success-custom" style="border-radius: 15px;">Assign Task</button>
                    </div>
                    <div class="col-sm-3">
                      <button type="submit" class="btn btn-danger-custom" data-dismiss="modal" style="border-radius: 15px;">Cancel</button>
                    </div>
                  </div>
                </div>
              </form> 
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-warning btn-menu" data-toggle="modal" data-target="#myModal" style="border-radius: 15px;">Assign New Task</button>
                </div>
              <?php } ?>
          ...
          <center ><h3 style="font-weight: bold;">Task Management Section</h3></center>
          <div class="gap"></div>
