...
if(isset($_POST['cancel_task_info'])){
                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                  ...
			                  <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <input type="text" name="t_start_time" id="t_start_time"  class="form-control" value="<?php echo $row['t_start_time']; ?>" disabled>
			                    </div>
			                  </div>
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">End Time</label>
			                    <div class="col-sm-7">
			                      <input type="text" name="t_end_time" id="t_end_time" class="form-control" value="<?php echo $row['t_end_time']; ?>" disabled>
			                    </div>
			                  </div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <button type="submit" name="cancel_task_info" class="btn btn-danger-custom">Cancel</button>
                              </div>
                            </div>
                          </form> 
                        </div>
