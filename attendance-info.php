    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
              ...
              ?>
                ...
                <div class="btn-group">
                  <form method="post" role="form" action="">
                    ...
                    <button type="submit" name="add_punch_in" class="btn btn-primary btn-lg rounded" style="border-radius: 15px">Clock In</button>
                  </form>
          ...
          <center><h3 style="font-weight: bold;">Manage Attendance</h3>  </center>
          <div class="gap"></div>
                ...
                <tr>
                  ...
                  <td style="text-align: center">
                    <form method="post" role="form" action="">
                      ...
                      <button type="submit" name="add_punch_out" class="btn btn-danger btn-xs rounded" style="border-radius: 14px; padding: 4px">Clock Out</button>
                    </form>
                  </td>
                <?php } ?>
                <?php if($user_role == 1){ ?>
