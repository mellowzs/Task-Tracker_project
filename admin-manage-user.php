    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center" required style="font-weight: bold;">Add Employee Info</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" placeholder="Enter Employee Name" name="em_fullname" list="expense" class="form-control input-custom" id="default" required required style="border-radius: 10px;">
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label col-sm-4">Username</label>
                    <div class="col-sm-6">
                      <input type="text" placeholder="Enter Employee username" name="em_username" class="form-control input-custom" required required style="border-radius: 10px;">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-4">Email</label>
                    <div class="col-sm-6">
                      <input type="email" placeholder="Enter Employee Email" name="em_email" class="form-control input-custom" required required style="border-radius: 10px;">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="btn btn-success-custom" required style="border-radius: 10px;">Add Employee</button>
                    </div>
                    <div class="col-sm-3">
                      <button type="submit" class="btn btn-danger-custom" data-dismiss="modal" required style="border-radius: 10px;">Cancel</button>
                    </div>
                  </div>
                </div>
              </form> 
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-success btn-menu" data-toggle="modal" data-target="#myModal" style="border-radius: 15px;">Add New Employee</button>
                </div>
              <?php } ?>
